...
const DEFAULT_JUMP_FORCE = -10; //changed the force
...
function preload() {
  ...
  playerRunAnimation = loadAnimation("assets/img/cap-walk/cap-walk_001.png", "assets/img/cap-walk/cap-walk_008.png");
